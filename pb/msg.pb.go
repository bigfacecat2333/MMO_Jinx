...
type SyncPid struct {
	...
	Pid int32 `protobuf:"varint,1,opt,name=Pid,proto3" json:"Pid,omitempty"` // 生成玩家的id
}
...
type Broadcast_Content struct {
	Content string `protobuf:"bytes,3,opt,name=Content,proto3,oneof"` // 世界聊天内容
}
...
var file_msg_proto_rawDesc = []byte{
	...
	0x44, 0x61, 0x74, 0x61, 0x42, 0x09, 0x5a, 0x02, 0x2e, 0x2f, 0xaa, 0x02, 0x02, 0x50, 0x62, 0x62,
